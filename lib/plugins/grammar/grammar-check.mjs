...
export class GrammarCheckPlugin extends BasePlugin {
  // 静态元数据
  static pluginType = "grammar";
  static description = "检查文本中是否存在错别字、语法错误、用词不当、存在歧义、不合逻辑、有悖常理等问题";
  ...
  constructor(config = {}) {
    super({
      description: GrammarCheckPlugin.description,
      version: GrammarCheckPlugin.version,
      ...config,
    });
...
<规则描述>
${GrammarCheckPlugin.description}
</规则描述>
